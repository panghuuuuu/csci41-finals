...
from .models import Item, SoldItem, DeliveredItem, IssuedItem, ReturnedItem, BatchInventory, ItemType

class ItemAdmin(admin.ModelAdmin):
    list_display = ('item_number', 'item_brand', 'item_model', 'item_qty', 'item_type', 'item_cost', 'item_SRP', 'item_total_cost')
    search_fields = ('item_brand', 'item_model', 'item_type')

@admin.register(SoldItem, DeliveredItem, IssuedItem, ReturnedItem)
