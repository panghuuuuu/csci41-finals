...
class Staff(models.Model):
    ...
    def __str__(self):
        return f"{self.staff_type}: {self.staff_first_name} {self.staff_last_name}"
...
class Receiver(models.Model):
    ...
    def __str__(self):
        return f"{self.staff.staff_number} {self.staff.staff_first_name} {self.staff.staff_last_name}"
...
class Order(models.Model):
    staff = models.ForeignKey('Staff', on_delete=models.CASCADE, related_name='ordered_items')
